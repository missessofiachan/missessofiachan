...
Technology has fascinated me since I was five years old. Today, I use that lifelong passion to build tools that solve real-world problems and make a positive impact. Or just create mods and game/toys for personal fun and enjoyment.
...
* 🛡️ **Core Interests:** App Sec (Application Security), Systems Engineering, and Game Engine Architecture.
* 🐧 **Platform Preference:** Exclusively utilizes **Linux** for all desktop and server environments.
...
I'm a software developer based in Australia, specializing in **cybersecurity**, **systems programming**, and **full-stack development**.
...
| --- | --- | --- | --- |
| **UZ Doom** | C | Custom game engine modding; created 3 mods so far as well as modfied personal fork to have rich discord presence with map/mod shown and live stats similar to real rtcw . | 🚀 Active |
| **RealRTCW Fork** | C/C++ | Custom source port fork; added Discord Rich Presence that shows live stats/map/mods loaded as well as a working flashlight that ai can react to also working on new sound systems for reverb and hrtf/dosal . | 🚀 Active |
| **Doom 3 BFA Mods** | C++ | Engine customization; implemented multiplayer bot AI for BFA source port. | 🛠️ In Dev |
